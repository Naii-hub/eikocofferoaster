...
@section('page-title', 'Edit Pesanan: ' . $pesanan->kode_pesanan)
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-2">
                    ...
                    <select name="user_id" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-coffee-500 focus:border-coffee-500 @error('user_id') border-red-500 @enderror">
                        @foreach($users as $user)
                            <option value="{{ $user->id }}" {{ old('user_id', $pesanan->user_id) == $user->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select name="jenis_pesanan" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-coffee-500 focus:border-coffee-500 @error('jenis_pesanan') border-red-500 @enderror">
                        <option value="Standar" {{ old('jenis_pesanan', $pesanan->jenis_pesanan) == 'Standar' ? 'selected' : '' }}>Standar</option>
                        <option value="Custom" {{ old('jenis_pesanan', $pesanan->jenis_pesanan) == 'Custom' ? 'selected' : '' }}>Custom</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="text" name="nama_produk" value="{{ old('nama_produk', $pesanan->nama_produk) }}" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-coffee-500 focus:border-coffee-500 @error('nama_produk') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="number" name="harga" value="{{ old('harga', $pesanan->harga) }}" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-coffee-500 focus:border-coffee-500 @error('harga') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="number" name="jumlah" value="{{ old('jumlah', $pesanan->jumlah) }}" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-coffee-500 focus:border-coffee-500 @error('jumlah') border-red-500 @enderror">
                ...
                <div class="col-span-2">
                    ...
                    <select name="status" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-coffee-500 focus:border-coffee-500 @error('status') border-red-500 @enderror">
                        ...
                        <option value="menunggu_dp" {{ old('status', $pesanan->status) == 'menunggu_dp' ? 'selected' : '' }}>Menunggu DP</option>
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="deskripsi" rows="3" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-coffee-500 focus:border-coffee-500 @error('deskripsi') border-red-500 @enderror">{{ old('deskripsi', $pesanan->deskripsi) }}</textarea>
